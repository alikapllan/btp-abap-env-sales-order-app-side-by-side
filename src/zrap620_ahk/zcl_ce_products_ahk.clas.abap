CLASS zcl_ce_products_ahk DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES t_business_data_external TYPE TABLE OF zce_products_ahk.

    TYPES t_product_range          TYPE RANGE OF zsc_products_ahk=>tys_a_product_class_type.
    TYPES t_business_data          TYPE zsc_products_ahk=>tyt_a_clfn_product_type.
...
CLASS zcl_ce_products_ahk IMPLEMENTATION.
  ...
  METHOD get_products.
    ...
    odata_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
                             is_proxy_model_key       = VALUE #( repository_id       = 'DEFAULT'
                                                                 proxy_model_id      = 'ZSC_PRODUCTS_AHK'
