CLASS zcl_rap100_gen_data_ahk DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
CLASS zcl_rap100_gen_data_ahk IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    " clear data
    DELETE FROM zahk_rap100_atrv.
    DELETE FROM zrap100_dtravahk.

    " insert travel demo data
    INSERT zahk_rap100_atrv FROM (
        SELECT FROM /dmo/travel AS travel
          ...
          UP TO 10 ROWS ).
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table zahk_rap100_atrv. | ).
  ENDMETHOD.
ENDCLASS.
